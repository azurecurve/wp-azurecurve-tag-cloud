...
= 2.0.2 =
* Fix bug with % showing in html as pc
= 2.0.1 =
* Fix bug with saving of network settings
= 2.0.0 =
* Add azurecurve menu
= 1.0.6 =
* Fix bug which caused tags not to be displayed
= 1.0.5 =
* Fix bug on new installation (fo5reach error if widget added before plugin configured)
= 1.0.4 =
* Fix bug with multisite admin menu link
= 1.0.3 =
* Fix bug order of tag cloud
= 1.0.2 =
* Fix bug in site options
= 1.0.1 =
* Fix error whereby network settings were not correctly applied
= 1.0.0 =
* First version
